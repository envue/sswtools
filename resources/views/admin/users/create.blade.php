...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('stripe_customer_id', trans('quickadmin.users.fields.stripe-customer-id').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('role_until', trans('quickadmin.users.fields.role-until').'', ['class' => 'control-label']) !!}
                    {!! Form::text('role_until', old('role_until'), ['class' => 'form-control datetime', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('role_until'))
                        <p class="help-block">
                            {{ $errors->first('role_until') }}
                        </p>
                    @endif
                </div>
            </div>
