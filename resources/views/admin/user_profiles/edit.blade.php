...
@section('content')
    ...
    {!! Form::model($user_profile, ['method' => 'PUT', 'route' => ['admin.user_profiles.update', $user_profile->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($user_profile->profile_image)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$user_profile->profile_image) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$user_profile->profile_image) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('location_latitude', $user_profile->location_latitude , ['id' => 'location-latitude']) !!}
                    {!! Form::hidden('location_longitude', $user_profile->location_longitude , ['id' => 'location-longitude']) !!}
                    <p class="help-block"></p>
