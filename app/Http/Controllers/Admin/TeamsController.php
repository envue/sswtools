...
class TeamsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $students = \App\Student::where('created_by_team_id', $id)->get();$users = \App\User::where('team_id', $id)->get();$time_entries = \App\TimeEntry::where('created_by_team_id', $id)->get();

        $team = Team::findOrFail($id);

        return view('admin.teams.show', compact('team', 'students', 'users', 'time_entries'));
    }
